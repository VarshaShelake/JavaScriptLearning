...
// console.log(`===== Total number of elements available in array ====`);
// let totalElements1 = arrayOfNumbers.length;
// console.log(`Total Elements in arrayOfNumbers --> ${totalElements1}`);

// let typeOfArray1= typeof arrayOfNumbers
// console.log(`Type of array-arrayNumbers-${typeOfArray1}`);
...
arrayOfNum.push(3); //adding ele at last
arrayOfNum.push(10,20,30)
console.log(arrayOfNum);
...
var arrayOfNum3 = [4, 5, 6, 8, 9, 33];
let popResult = arrayOfNum3.pop();
console.log(popResult);
console.log(arrayOfNum3);

console.log(`======== shift() methods=========`);
var arrayOfNum4 = [4, 5, 6, 8, 9, 33];
let shiftResult = arrayOfNum4.shift();
console.log(shiftResult);
console.log(arrayOfNum4);
